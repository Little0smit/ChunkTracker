...
public enum SkillingNodeType {
	RUNECRAFTING_ALTAR, FURNACE, SPINNING_WHEEL, LOOM,
	//Every pottery oven has a wheel next to it.
	POTTERY_OVEN, POTTERY_WHEEL,
	...
	//How to implement cooking stuff on a fire?
	RANGE,
